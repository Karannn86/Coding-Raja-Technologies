...
import { initializePlaylist } from "../src/initialize";
import Navbar from "../src/components/Navbar";
import { MusicContext } from "../src/Context"; 
...
function App() {
  ...
  const fetchMusicData = async () => {
    ...
    try {
      const response = await fetch(
        `https://v1.nocodeapi.com/karan897/spotify/fsbjTMZDbwtyfyTO/search?q=${keyword}&type=track&offset=${resultOffset}`,
        {
          headers: {
  ...
  return (
    <>
      ...
      <div id="App_wall" className="container">
