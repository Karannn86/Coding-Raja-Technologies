...
import PinnedMusic from "../components/PinnedMusic";
    ...
    <>
      <nav className="navbar navbar-dark navbar-expand-lg bg-dark sticky-top">
        <div className="container-fluid">
          ...
          <i class="ri-headphone-line"></i> Potify
          </Link>
          <div>
            <button
              type="button"
            ...
            >
              <i class="ri-bookmark-line"></i> {pinnedMusic.length}
            </button>
            <button
              type="button"
              data-bs-toggle="modal"
              ...
              className="btn btn-secondary btn-sm mx-1"
            >
              <i class="ri-heart-line"></i> {likedMusic.length}
            </button>
          </div>
